...
namespace Oprim.Ui.Components.Shared.Dialogs.ProjectCostBreakdowns;

public partial class ProjectCostBreakdownDialog
{
    [CascadingParameter] private IMudDialogInstance MudDialog { get; set; } = default!;
    [Parameter] public ProjectCostBreakdown? Item { get; set; }
    [Inject] private IMediator _mediator { set; get; }
    private MudForm? _form;
    private ProjectCostBreakdown _model = new();
    ...
    protected override async Task OnInitializedAsync()
    {
        if (Item is null)
        {
            _model = new ProjectCostBreakdown();
